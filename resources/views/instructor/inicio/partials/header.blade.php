...
<body class="app sidebar-mini">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      <a class="app-menu__item" href="{{ route('colab.gestion_clases') }}"></i><span class="app-menu__label">Gestion de
          clases</span></a>
      <a class="app-menu__item" href="{{ route('colab.inscripcion') }}"></i><span class="app-menu__label">Inscripcíon de
          Estudiantes</span></a>
